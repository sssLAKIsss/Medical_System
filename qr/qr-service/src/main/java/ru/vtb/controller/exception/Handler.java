...
import ru.vtb.exception.message.Messages;
...
import static ru.vtb.exception.message.MessagesKeys.ERROR_INTERNAL_SERVER;
import static ru.vtb.exception.message.MessagesKeys.MSG_DEFAULT;
import static ru.vtb.exception.message.MessagesKeys.MSG_VALIDATION_ERROR;
import static ru.vtb.exception.message.MessagesKeys.PREFIX_VALIDATION;
...
public class Handler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleLocalizedException(AbstractLocalizedException ex,
                                                           WebRequest request) {
